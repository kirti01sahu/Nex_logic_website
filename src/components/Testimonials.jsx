  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: 'Nextlogic Innovation Private Limited transformed our entire digital infrastructure. Their expertise and dedication to our success exceeded all expectations. The ROI has been phenomenal.',
    },
    {
      name: 'Michael Chen',
      position: 'CTO',
      ...
      rating: 5,
      text: 'Working with Nextlogic Innovation Private Limited was a game-changer for our organization. Their team brought innovative solutions and delivered results faster than we thought possible.',
    },
    {
      ...
      rating: 5,
      text: 'The level of professionalism and expertise demonstrated by Nextlogic Innovation Private Limited is unmatched. They truly understand our business needs and deliver solutions that work.',
    },
    {
      name: 'David Thompson',
      ...
      rating: 5,
      text: 'Exceptional service from start to finish. Nextlogic Innovation Private Limited not only met our technical requirements but also provided strategic guidance that added tremendous value.',
    },
    {
      name: 'Lisa Anderson',
      ...
      rating: 5,
      text: 'The digital marketing strategies implemented by Nextlogic Innovation Private Limited increased our online presence by 300%. Their data-driven approach delivers measurable results.',
    },
  ];
