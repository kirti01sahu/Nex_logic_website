  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: 'Nexlogic transformed our entire digital infrastructure. Their expertise and dedication to our success exceeded all expectations. The ROI has been phenomenal.',
    },
    {
      name: 'Michael Chen',
      position: 'CTO',
      ...
      rating: 5,
      text: 'Working with Nexlogic was a game-changer for our organization. Their team brought innovative solutions and delivered results faster than we thought possible.',
    },
    {
      ...
      rating: 5,
      text: 'The level of professionalism and expertise demonstrated by Nexlogic is unmatched. They truly understand our business needs and deliver solutions that work.',
    },
    {
      name: 'David Thompson',
      ...
      rating: 5,
      text: 'Exceptional service from start to finish. Nexlogic not only met our technical requirements but also provided strategic guidance that added tremendous value.',
    },
    {
      name: 'Lisa Anderson',
      ...
      rating: 5,
      text: 'The digital marketing strategies implemented by Nexlogic increased our online presence by 300%. Their data-driven approach delivers measurable results.',
    },
  ];
