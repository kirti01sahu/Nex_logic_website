...
const aboutSchema = {
  ...
  '@type': 'AboutPage',
  name: 'About Nextlogic Innovation Private Limited',
  url: 'https://naxlogic.com/about',
  description: 'Learn about Nextlogic Innovation Private Limited — a consulting-led AI and software company founded in 2026, operating at naxlogic.com.',
  mainEntity: {
    '@type': 'Organization',
    name: 'Nextlogic Innovation Private Limited',
    alternateName: 'Nextlogic',
...
const AboutPage = () => {
  return (
    <div className="pt-20">
      <SEOHead
        title="About Us — Nextlogic Innovation Private Limited"
        description="Nextlogic Innovation Private Limited (naxlogic.com) is a consulting-led technology company delivering AI, ERP/CRM, and custom software. Learn who we are, our mission and leadership."
        canonical="/about"
        schema={aboutSchema}
      />
      {/* Hero */}
        ...
        <div className="container-custom relative z-10">
          <ScrollAnimation>
            <div className="text-center max-w-4xl mx-auto">
              <h1 className="heading-xl mb-6 text-white drop-shadow-lg">Nextlogic Innovation Private Limited — Global Consulting & AI Technology Company</h1>
              <p className="text-xl text-white/90 leading-relaxed drop-shadow">
                Nextlogic Innovation Private Limited is a consulting-driven technology company delivering AI-powered platforms, enterprise software, and strategic digital solutions. Formed in April 2026, Nextlogic (naxlogic.com) helps organisations design digital strategy, build scalable systems, and achieve measurable business outcomes with confidence and security.
              </p>
            </div>
          </ScrollAnimation>
        </div>
          ...
          <ScrollAnimation>
            <div className="space-y-8">
              <p className="text-body text-lg">
                Nextlogic Innovation Private Limited is a consulting-led technology company that architects AI-driven platforms, enterprise-grade software, and strategic digital solutions for enterprises, startups, and public institutions. Founded in April 2026, Nextlogic is focused on building practical, high-impact digital systems from day one.
              </p>
              <p className="text-body text-lg">
                Operating at the intersection of consulting, engineering, and artificial intelligence, Nextlogic bridges the gap between strategic vision and execution. Our leadership teams modernise technology landscapes, optimise operations, and build future-ready digital ecosystems that enable organisations to compete, innovate, and grow in the digital economy.
              </p>
              <p className="text-body text-lg">
                As a consulting and technology partner, Nextlogic delivers enterprise-grade solutions across IT consulting, software engineering, AI and automation, SaaS platforms, cloud transformation, cybersecurity, and e-governance. Our multidisciplinary teams combine strategic advisory with deep engineering capabilities to design secure, scalable, and high-performance systems aligned with real business objectives.
              </p>
            </div>
          </ScrollAnimation>
        </div>
        ...
        <div className="container-custom max-w-5xl">
          ...
          <ScrollAnimation>
            <div className="space-y-6 text-body text-lg">
              ...
              <p>
                Having witnessed firsthand where strategies fail — not in vision, but in execution — he founded Nextlogic Innovation Private Limited with a clear mission: to bridge this critical gap. He believes that in today’s rapidly evolving digital economy, organizations must go beyond adopting technology and focus on building intelligent, future-ready systems that continuously evolve. His leadership combines consulting precision with entrepreneurial agility, enabling businesses to move faster, scale smarter, and create long-term value.
              </p>
          ...
          <ScrollAnimation>
            <div className="text-center mb-12">
              ...
              <p className="text-body max-w-4xl mx-auto mb-8">
                Nextlogic serves a diverse portfolio of clients across government, IT, BFSI, education, real estate, and enterprise sectors. Our proprietary SaaS platforms and AI-driven solutions empower organisations to optimise operations, enhance digital resilience, and deliver superior customer experiences.
              </p>
          ...
          <ScrollAnimation>
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-body text-lg mb-6">
                At Nextlogic, innovation is not an option — it is a discipline. We continuously invest in AI, automation, cybersecurity, and emerging technologies to help organisations stay ahead of disruption.
              </p>
              <p className="text-xl font-heading font-semibold text-black">
                Nextlogic Innovation Private Limited, founded in April 2026, is where consulting meets engineering and strategy becomes scalable technology.
              </p>
            </div>
          </ScrollAnimation>
        </div>
