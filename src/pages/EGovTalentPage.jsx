...
const EGovTalentPage = () => {
  ...
  return (
    <div className="bg-cream dark:bg-charcoal text-charcoal dark:text-[#E6DED3] transition-colors duration-300">
      ...
      {/* SECTION – GROW WITH NEXLOGIC & EGOVTALENT */}
      <section className="py-24 md:py-36 bg-cream dark:bg-charcoal px-4 md:px-6">
        <div className="container-custom">
          <ScrollAnimation>
            <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24">
              <span className="text-[10px] uppercase tracking-widest-4xl text-[#6F6A63] dark:text-[#D2C8BB]/60 font-bold mb-4 block">Business Opportunities</span>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-light text-charcoal dark:text-white mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <ScrollAnimation>
              <div className="bg-white dark:bg-charcoal-light rounded-2xl p-8 shadow-warm border border-gray-100 dark:border-white/5 hover:shadow-card hover:border-[#A8B5A2]/40 hover:-translate-y-1 transition-all duration-300 h-full flex flex-col justify-between group">
                <div>
                  <div className="w-14 h-14 rounded-xl bg-[#384F3E]/10 dark:bg-[#A8B5A2]/10 flex items-center justify-center mb-6 group-hover:bg-[#384F3E]/20 transition-colors duration-300">
                    <span className="material-symbols-outlined text-3xl text-sage-green">handshake</span>
                  </div>
                  <span className="text-[10px] uppercase tracking-widest font-bold text-sage-green mb-2 block">Partnership</span>
                  <h3 className="text-xl md:text-2xl font-heading font-semibold text-charcoal dark:text-white mb-4">
                    Become Our Partner
                  </h3>
                  ...
                  <ul className="space-y-3 mb-8">
                    {[
                      ...
                      <li key={i} className="flex items-start gap-3 text-xs md:text-sm text-[#6F6A63] dark:text-[#D2C8BB]/70 font-light">
                        <span className="material-symbols-outlined text-base text-sage-green flex-shrink-0 mt-0.5">check_circle</span>
                        <span>{point}</span>
                      </li>
                    ))}
                  </ul>
                ...
                <a href="/contact">
                  <button className="w-full bg-[#384F3E] hover:bg-[#A8B5A2] text-white hover:text-charcoal py-3 px-6 rounded-xl font-bold text-xs uppercase tracking-widest transition-all duration-300 hover:scale-[1.02]">
                    Become a Partner
                  </button>
                </a>
              </div>
            ...
            <ScrollAnimation>
              <div className="bg-[#384F3E] dark:bg-[#2A3D30] rounded-2xl p-8 shadow-warm border border-[#384F3E]/20 dark:border-white/5 hover:shadow-card hover:border-[#A8B5A2]/40 hover:-translate-y-1 transition-all duration-300 h-full flex flex-col justify-between group">
                <div>
                  <div className="w-14 h-14 rounded-xl bg-white/10 flex items-center justify-center mb-6 group-hover:bg-white/20 transition-colors duration-300">
                    <span className="material-symbols-outlined text-3xl text-[#A8B5A2]">manage_accounts</span>
                  </div>
                  <span className="text-[10px] uppercase tracking-widest font-bold text-[#A8B5A2] mb-2 block">HR Services</span>
                  <h3 className="text-xl md:text-2xl font-heading font-semibold text-white mb-4">
                    Outsourced HR Recruitment
                  </h3>
                  <p className="text-[#E6DED3]/80 text-sm font-light leading-relaxed mb-6">
                  ...
                  <ul className="space-y-3 mb-8">
                    {[
                      ...
                      <li key={i} className="flex items-start gap-3 text-xs md:text-sm text-[#E6DED3]/80 font-light">
                        <span className="material-symbols-outlined text-base text-[#A8B5A2] flex-shrink-0 mt-0.5">check_circle</span>
                        <span>{point}</span>
                      </li>
                    ))}
                  </ul>
                ...
                <a href="/contact">
                  <button className="w-full bg-white/10 hover:bg-white/20 text-white border border-white/20 hover:border-white/40 py-3 px-6 rounded-xl font-bold text-xs uppercase tracking-widest transition-all duration-300 hover:scale-[1.02]">
                    Talk to Our Team
                  </button>
                </a>
              </div>
            ...
            <ScrollAnimation>
              <div className="bg-white dark:bg-charcoal-light rounded-2xl p-8 shadow-warm border border-gray-100 dark:border-white/5 hover:shadow-card hover:border-[#A8B5A2]/40 hover:-translate-y-1 transition-all duration-300 h-full flex flex-col justify-between group">
                <div>
                  ...
                  <span className="text-[10px] uppercase tracking-widest font-bold text-sage-green mb-2 block">Freelancer</span>
                  <h3 className="text-xl md:text-2xl font-heading font-semibold text-charcoal dark:text-white mb-4">
                    Freelancer HR
                  </h3>
                  <p className="text-[#6F6A63] dark:text-[#D2C8BB]/70 text-sm font-light leading-relaxed mb-6">
